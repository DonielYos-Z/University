...
namespace UniversityApp.Forms.DataModels
{
    ...
    internal abstract class Person
    {
        ...
        // Constructor
        protected Person(string id, string name, int age, string phoneNumber, string email, List<string> messageList, string filepath)
        {
            SetID(id);
            SetName(name);
            SetAge(age);
        ...
        {
            if (messageList == null)
                throw new ArgumentNullException(nameof(messageList), "Message list cannot be null.");
